        ...
        <>
            <ul className="projects">
                <li className="project">
                    <SquareImage href="" src="/static/VShred-Web.png" alt="V Shred Logo" />
                    <div className="project__content">
                        <h1>
                            <a href="" target="_blank" rel="noopener noreferrer">V Shred</a>
                        </h1>
                        ...
                        <h4>Key Outcomes</h4>
                        <ul>
                            <li>Acted as a liaison with iOS developers, assuring identical functioning of both iOS and Android applications. I streamlined the seamless flow of day-to-day tasks, complying with Agile methodology.</li>
                            <li>I functioned as the only Android developer and in charge of writing features for the Android application processing over $15,000 in revenue daily.</li>
                        </ul>
                        ...
                        <h4>Key Outcomes</h4>
                        <ul>
                            <li>I adhered to Agile methodology and steer the completion/partition of appointed assignments effectually.</li>
                            <li>Ensured secure user payments by implementing new website products through Stripe and Braintree.</li>
                            <li>Wrote features for multiple E-Commerce systems processing one hundred million dollars annually.</li>
                        </ul>
                    </div>
                </li>
                <li className="project">
                    <SquareImage background="#f16870" href="" src="/static/Jijenge-Web.png" alt="Jijenge Logo" />
                    <div className="project__content">
                        <h1>
                            <a href="" target="_blank" rel="noopener noreferrer">Jijenge Academy</a>
                        </h1>
                        <h2>Full Stack Engineer</h2>
                        ...
                        <h4>Key Outcomes</h4>
                        <ul>
                            <li>Generated revenue up to $10K in the first month to mentor Kenyan students on technical skills.</li>
                        </ul>
                    </div>
                </li>
                <li className="project">
                    <SquareImage href="" src="/static/Trilogy-Web.png" alt="Trilogy Logo" />
                    <div className="project__content">
                        <h1>
                            <a href="" target="_blank" rel="noopener noreferrer">SculptNation</a>
                        </h1>
                        ...
                        <h4>Key Outcomes</h4>
                        <ul>
                            <li>I saw a dramatic improvement in student performance and understanding of software engineering principles through out tutoring sessions.</li>
                        </ul>
                    </div>
                </li>
            </ul>
            ...
            <style jsx>{`
                ...
                .project__content h1 a,
                .project__content h1 a:active,
                .project__content h1 a:hover {
